...
OutputFileNames = "/data_CMS/cms/strebler/HGC/SingleNu_PU200_JB/cone_ntuples/cone_ntuples" # base of the output file name, they will be saved in res directory
...
for x in range(1, int(NumberOfJobs)+1):
   ...
   with open('job.sh', 'w') as fout:
      ...
      fout.write(".L compute_PU_cones.C+\n")
      fout.write("create_cones(\"/data_CMS/cms/strebler/HGC/SingleNu_PU200_JB/jet_ntuples_merged/ntuple_jet_merged_"+str(x)+".root\",\"HGCalTriggerNtuple\",\""+OutputFileNames+"_"+str(x)+".root\");\n")
      fout.write(".q\n")
      fout.write("EOF\n")
